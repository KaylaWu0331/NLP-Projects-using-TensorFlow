...
np.random.seed(42)
# Load data
X_train, y_train = dataset_reader('DATA/rt-polarity.train.vecs')
X_dev, y_dev = dataset_reader('DATA/rt-polarity.dev.vecs')
X_test, y_test = dataset_reader('DATA/rt-polarity.test.vecs')
